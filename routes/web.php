...
use App\Http\Controllers\BothTeamsToScoreController;
...
// AJAX endpoint for loading more leagues
Route::post('/load-more-leagues', [HomeController::class, 'loadMoreLeagues'])->name('load.more.leagues');
...
Route::get('/todays-prediction/double-chance-predictions', [DoubleChanceController::class, 'index'])->name('double.chance');
Route::get('/todays-prediction/predictions-both-to-score', [BothTeamsToScoreController::class, 'index'])->name('btts');
Route::get('/todays-prediction/predictions-under-over', [OverUnder25Controller::class, 'index'])->name('over.under.25');
Route::get('/todays-prediction/predictions-halftime-fulltime', [HalfTimeFullTimeController::class, 'index'])->name('htft');
...
Route::get('/faq', [PageController::class, 'faqs'])->name('faqs');
Route::get('/privacy', [PageController::class, 'privacy'])->name('privacy');
Route::get('/about-us', [PageController::class, 'about'])->name('about');
Route::get('/refund', [PageController::class, 'refund'])->name('refund');
Route::get('/links', [PageController::class, 'partners'])->name('partners');
