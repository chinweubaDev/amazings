            ...
            @foreach($grouped as $leagueKey => $matches)
                ...
                @foreach($matches as $match)
                    ...
                    <div class="match-row">
                        ...
                        <div class="odds">
                            @if(isset($match['odds']) && isset($match['odds']['home']) && $match['odds']['home'])
                            ...
                            @if(isset($match['odds']) && isset($match['odds']['draw']) && $match['odds']['draw'])
                            ...
                            @if(isset($match['odds']) && isset($match['odds']['away']) && $match['odds']['away'])
